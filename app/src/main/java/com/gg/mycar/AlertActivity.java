    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (bundle != null)
        {
            ...
            for (int i=0; i<msgs.length; i++)
            {
                ...
                if(msgs[i].getOriginatingAddress().equals("0891053596") && msgs[i].getMessageBody().equals("alert"))
                {
            ...
            builder.setMessage("This is Alert from your car. Please check it now!!")
                    .setCancelable(false)
